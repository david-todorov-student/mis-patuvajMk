...
import 'package:patuvaj_mk/main.dart';
import './signup.dart';
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: () {
                                      ...
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => MyHomePage(title: "Patuvaj MK",)));
                                    },
                                    child: Container(
                                      alignment: Alignment.center,
                                      width: double.infinity,
                                  ...
                                  Positioned(child: (isLoading) ? Center(
                                      child: Container(
                                          height:26,
                                          width: 26,
